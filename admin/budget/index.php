...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="manage_budget" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Tambah</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('#manage_budget').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Pemasukan Baru",'budget/manage_budget.php')
		})
		$('.manage_budget').click(function(){
