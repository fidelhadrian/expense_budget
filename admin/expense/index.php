...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="manage_expense" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Tambah</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('#manage_expense').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Pengeluaran Baru",'expense/manage_expense.php')
		})
		$('.manage_expense').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Edit Pengeluaran",'expense/manage_expense.php?id='+$(this).attr('data-id'))
		})
