          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number text-right"> Rp
                  <?php 
...
<div class="row">
  <div class="col-lg-12">
    <!-- Current Budget in each Categories -->
    <h4>Keuntungan setiap Kategori</h4>
    <hr>
  </div>
</div>
...
<div class="col-md-12">
  <h3 class="text-center" id="noData" style="display:none">Buat Kategori Baru</h3>
</div>
<script>
  function check_cats(){
