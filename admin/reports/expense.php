    ...
    <div class="card-body">
        <form id="filter-form">
            <div class="row align-items-end">
                ...
                <div class="form-group col-md-3">
                    <label for="date_start">Sampai tanggal</label>
        ...
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Laporan Pengeluaran</b></h3>
                <hr style="width:15%">
                <p class="text-center m-0">Sejak <b><?php echo date("M d, Y",strtotime($date_start)) ?></b> hingga <b><?php echo date("M d, Y",strtotime($date_end)) ?></b></p>
                <hr>
            </div>
